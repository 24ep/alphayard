...
const sendResponse = (res: Response, statusCode: number, success: boolean, data?: any, message?: string, error?: string) => {
  const response: any = { 
    success,
...
router.post('/sso-providers', async (req: Request, res: Response) => {
  try {
