...
const httpRequestDuration = new Histogram({
  name: 'boundary_http_request_duration_seconds',
...
const httpRequestTotal = new Counter({
  name: 'boundary_http_requests_total',
...
const activeConnections = new Gauge({
  name: 'boundary_active_connections',
  help: 'Number of active connections',
  registers: [registry],
});

const databaseConnections = new Gauge({
  name: 'boundary_database_connections',
  help: 'Number of active database connections',
  registers: [registry],
});

const redisConnections = new Gauge({
  name: 'boundary_redis_connections',
  help: 'Number of active Redis connections',
  registers: [registry],
});

const authenticationAttempts = new Counter({
  name: 'boundary_authentication_attempts_total',
...
const rateLimitHits = new Counter({
  name: 'boundary_rate_limit_hits_total',
...
const userSessions = new Gauge({
  name: 'boundary_user_sessions',
  help: 'Number of active user sessions',
  registers: [registry],
});

const fileUploads = new Counter({
  name: 'boundary_file_uploads_total',
...
const apiResponseSize = new Histogram({
  name: 'boundary_api_response_size_bytes',
