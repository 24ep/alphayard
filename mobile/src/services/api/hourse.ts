...
export const familyApi = {
  ...
  acceptFamilyInvitation: async (invitationId: string): Promise<{ success: boolean; message: string }> => {
    const response = await api.post(`/families/invitations/${invitationId}/accept`);
    return response.data;
  },

  // Decline hourse invitation
  declineFamilyInvitation: async (invitationId: string): Promise<{ success: boolean; message: string }> => {
