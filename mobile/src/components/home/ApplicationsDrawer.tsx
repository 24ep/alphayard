...
export const ApplicationsDrawer: React.FC<ApplicationsDrawerProps> = ({ visible, onClose }) => {
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'flex-end' }}>
        <View style={{ backgroundColor: '#FFFFFF', borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: '90%', overflow: 'hidden' }}>
          {/* Header */}
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: 16, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' }}>
            <View style={{ flex: 1 }}>
            ...
            <TouchableOpacity onPress={onClose}>
              <CoolIcon name="close" size={22} color="#6B7280" />
            </TouchableOpacity>
          </View>
