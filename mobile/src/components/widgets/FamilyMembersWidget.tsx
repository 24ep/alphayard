    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>hourse Members</Text>
        </View>
        <View style={styles.emptyState}>
          <IconMC name="account-group" size={48} color="#CCC" />
          <Text style={styles.emptyText}>No hourse members yet</Text>
          <Text style={styles.emptySubtext}>Invite hourse members to get started</Text>
        </View>
      </View>
    );
  }
