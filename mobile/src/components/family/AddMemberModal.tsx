...
const AddMemberModal: React.FC<AddMemberModalProps> = ({
  ...
  const roles = [
    { key: 'admin', label: 'Admin', description: 'Full access to hourse settings and management' },
    { key: 'member', label: 'Member', description: 'Can view and participate in hourse activities' },
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.noteSection}>
            ...
            <Text style={styles.noteText}>
              The member will receive an invitation to join your hourse. They can accept or decline the invitation.
            </Text>
          </View>
        </ScrollView>
      </View>
