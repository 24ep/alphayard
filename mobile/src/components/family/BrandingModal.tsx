    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>hourse Branding</Text>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.previewSection}>
            ...
            <View style={[styles.previewCard, { backgroundColor: formData.primaryColor }]}>
              <Text style={styles.previewName}>{formData.customName || 'hourse Name'}</Text>
              <Text style={styles.previewSubtitle}>Your hourse</Text>
            </View>
          </View>

          {/* Custom Name */}
          <View style={styles.inputSection}>
            <Text style={styles.inputLabel}>Custom hourse Name</Text>
            <TextInput
              style={styles.textInput}
              value={formData.customName}
              onChangeText={(text) => setFormData(prev => ({ ...prev, customName: text }))}
              placeholder="Enter custom hourse name"
          ...
          <View style={styles.inputSection}>
            ...
            <View style={styles.featuresList}>
              <View style={styles.featureItem}>
                ...
                <Text style={styles.featureText}>Custom hourse name in app</Text>
              </View>
              <View style={styles.featureItem}>
                <IconIon name="checkmark-circle" size={16} color="#4CAF50" />
              ...
              <View style={styles.featureItem}>
                <IconIon name="checkmark-circle" size={16} color="#4CAF50" />
                <Text style={styles.featureText}>Custom hourse avatar</Text>
              </View>
              <View style={styles.featureItem}>
                <IconIon name="checkmark-circle" size={16} color="#4CAF50" />
