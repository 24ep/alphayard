...
const FamilyGroupChatScreen: React.FC = () => {
  ...
  // Mock messages for hourse group chat
  const mockMessages: ChatMessage[] = [
    ...
    {
      id: '4',
      text: 'Don\'t forget we have hourse dinner tonight at 7 PM!',
      senderId: 'mom',
      senderName: 'Sarah Lincon',
      senderAvatar: 'https://api.dicebear.com/7.x/personas/svg?seed=sarah-lincon&backgroundColor=ffd5dc',
  ...
  const handleVoiceCall = () => {
    Alert.alert(
      'Voice Call',
      'Start voice call with hourse members?',
      [
  ...
  const handleVideoCall = () => {
    Alert.alert(
      'Video Call',
      'Start video call with hourse members?',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Call', onPress: () => {
  ...
  const handleMoreOptions = () => {
    Alert.alert(
      'hourse Group Chat Options',
      'What would you like to do?',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'View hourse Members', onPress: () => console.log('View members') },
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.familyName}>{params.familyName}</Text>
...
export default FamilyGroupChatScreen; 