...
const mockFamily = {
  ...
  description: 'A loving hourse of 5 members',
  createdAt: new Date('2015-03-15'), // 9 years ago
  photo: 'https://via.placeholder.com/300x300/FF6B6B/FFFFFF?text=hourse',
  members: [
    {
      id: '1',
      name: 'John Johnson',
      role: 'Father',
      age: 45,
      avatar: 'https://via.placeholder.com/100x100/4ECDC4/FFFFFF?text=JJ',
    ...
    },
    {
      ...
      role: 'Mother',
      age: 42,
      avatar: 'https://via.placeholder.com/100x100/45B7D1/FFFFFF?text=SJ',
    ...
    },
    {
      ...
      role: 'Daughter',
      age: 18,
      avatar: 'https://via.placeholder.com/100x100/96CEB4/FFFFFF?text=EJ',
    ...
    },
    {
      ...
      role: 'Son',
      age: 15,
      avatar: 'https://via.placeholder.com/100x100/FFEAA7/FFFFFF?text=MJ',
    ...
    },
    {
      ...
      role: 'Grandmother',
      age: 68,
      avatar: 'https://via.placeholder.com/100x100/DDA0DD/FFFFFF?text=GR',
...
const FamilyDetailScreen: React.FC = () => {
  ...
  const calculateYearsTogether = () => {
    const now = new Date();
    const diffTime = Math.abs(now.getTime() - mockFamily.createdAt.getTime());
  ...
  const handleRemoveMember = (member: any) => {
    Alert.alert(
      'Remove Member',
      `Are you sure you want to remove ${member.name} from the hourse?`,
      [
        ...
        { 
          ...
          style: 'destructive',
          onPress: () => {
            Alert.alert('Member Removed', `${member.name} has been removed from the hourse`);
            onMemberClose();
          }
        },
      ]
      ...
      <Box bg={cardBgColor} px={4} py={3} shadow={2}>
        <HStack justifyContent="space-between" alignItems="center">
          ...
          <HStack space={4} alignItems="center">
            <Pressable onPress={() => navigation.navigate('FamilySettings')}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <HStack space={4} minW="100%">
            ...
            >
              ...
              >
                Members ({mockFamily.members.length})
              </Text>
            </Pressable>
            <Pressable
              minW={80}
          ...
          <VStack space={4}>
              ...
              <HStack space={4} alignItems="center">
                ...
                <VStack flex={1}>
                  ...
                  <Text style={textStyles.body1} color="gray.500">
                    {mockFamily.description}
                  </Text>
                  <HStack space={2} mt={2}>
                    <Badge colorScheme="blue" variant="subtle">
                      {mockFamily.stats.yearsTogether} years together
                    </Badge>
                    <Badge colorScheme="green" variant="subtle">
                      {mockFamily.stats.totalMembers} members
                    </Badge>
                  </HStack>
                </VStack>
              </HStack>
            ...
            <Box bg={cardBgColor} borderRadius="lg" p={4} shadow={2}>
              ...
              <Text style={textStyles.body} color="gray.600">
                {mockFamily.createdAt.toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}
              ...
              <VStack space={3}>
                ...
                <Box bg={colors.gray[50]} p={3} borderRadius="md">
                  ...
                  <Text style={textStyles.body1} color="gray.600">
                    ...
                    • Family photo session scheduled
                  </Text>
                </Box>
