    ...
    try {
        ...
        const basicsQuery = `
            SELECT 
                ...
                (SELECT COUNT(*) FROM bondarys.chat_messages) as total_messages
        `;
        ...
        const recentQuery = `
            SELECT 
                ...
                (SELECT COUNT(*) FROM bondarys.chat_messages WHERE created_at >= NOW() - INTERVAL '1 day' * $1) as recent_messages,
