 ...
 */
router.get('/types', async (req: AdminRequest, res: Response) => {
    try {
 ...
 */
router.get('/types/:id', async (req: AdminRequest, res: Response) => {
    try {
        const { id } = req.params;
 ...
 * Update entity type
 */
router.put('/types/:id', async (req: AdminRequest, res: Response) => {
    try {
        const { id } = req.params;
 ...
 */
router.delete('/types/:id', async (req: AdminRequest, res: Response) => {
    try {
        const { id } = req.params;
 ...
 */
router.get('/:typeName', async (req: AdminRequest, res: Response) => {
    try {
 ...
 * Create new entity
 */
router.post('/:typeName', async (req: AdminRequest, res: Response) => {
    try {
        const { typeName } = req.params;
 ...
 */
router.delete('/:typeName/:id', async (req: AdminRequest, res: Response) => {
    try {
        const { id } = req.params;
