...
const options = {
  definition: {
    ...
    info: {
      title: 'Bondarys API',
      version: '1.0.0',
      description: 'Comprehensive API documentation for Bondarys family management platform',
      contact: {
        name: 'API Support',
        email: 'support@bondarys.com',
        url: 'https://bondarys.com/support'
      },
      license: {
        name: 'MIT',
    ...
    servers: [
      ...
      {
        url: 'https://staging-api.bondarys.com',
...
export function setupSwagger(app: Application): void {
  ...
  const swaggerUiOptions = {
    ...
    `,
    customSiteTitle: 'Bondarys API Documentation',
