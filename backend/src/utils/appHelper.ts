...
const DEFAULT_APP_SLUG = 'bondarys';
 ...
 */
export async function getBondaryApplicationId(): Promise<string | undefined> {
    return getDefaultAppId();
}

/**
 * Get the default application ID (bondarys)
...
export async function getDefaultAppId(): Promise<string | undefined> {
    ...
    // Query database - try both 'bondarys' and 'bondary' slugs for compatibility
