    ...
    try {
        ...
        for (const type of entityTypes) {
            await prisma.$executeRaw(Prisma.sql`
                ...
                VALUES (${type.name}, ${type.display_name}, ${type.description}, ${type.icon}, true)
        ...
        // Check entity types
        const types = await prisma.$queryRawUnsafe(`SELECT name, display_name FROM entity_types ORDER BY name`);
        console.log('\n📦 Entity Types:');
