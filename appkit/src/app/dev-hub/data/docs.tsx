...
export interface DocContent {
  title: string
  description: string
  content: (props: { CodeBlock: React.ComponentType<any> }) => React.ReactNode
    ...
    content: ({ CodeBlock }) => (
      <div className="space-y-8">
        ...
        <CodeBlock 
          id="init"
          language="typescript"
          code={`import { AppKit } from 'appkit-sdk';
...
#  -d "client_secret=YOUR_CLIENT_SECRET"`}
  ...
  'home': {
    title: 'Developer Hub',
    description: 'Welcome to AppKit Developer Hub. Everything you need to integrate identity gateway.',
    content: () => (
      <div className="space-y-6">
        <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.1]">
